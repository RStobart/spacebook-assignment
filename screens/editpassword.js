  ...
  render() {
    return (
      <View style={style.editemail_view}>
        ...
        <TouchableOpacity style={style.editpassword_button} accessible accessibilityLabel="Go back" accessibilityHint="Return to the edit profile menu" onPress={() => this.props.navigation.navigate('EditMenu')}>
          <Text>GO BACK</Text>
        </TouchableOpacity>
